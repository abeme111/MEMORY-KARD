...
question_list = []
question_list.append(Question('Вы хотите поделить польшу','естественно','да','агпукгшпурппоукшрукш','нет'))
question_list.append(Question('Вы любите есть людей','только детей','нет я собак','я на диете','я ем только овощи'))
question_list.append(Question('Сколько будет 2+2','4','6','я не знаю','55'))
question_list.append(Question('Из пунка ъ в ь поехала твоя кукуха вопрос кто такая света','это мой гриб','амеба','гьетущиьешишкеишшкьни','не знаю'))
...
window.setWindowTitle('Выиграть в танки')
